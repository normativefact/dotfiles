...
hl.bind(mainMod .. " + ", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd("kitty --class scratchpad -e nvim /home/normativefact/notes/ ."))
